...
public class RentalService {
    ...
    public String bookRental(String customerID, String plateID, String locationID, Timestamp pickUpDateTime)
    {
        ...
        // GENERATE RENTAL ID
        String rentalID = rentalDAO.generateRentalID();
    ...
    public boolean startRental(String rentalID) {
        return startRental(rentalID, new Timestamp(System.currentTimeMillis()));
    }
    
    /**
     * Start a rental with custom start time (Admin override)
     * Allows admin to set a specific start time (e.g., for backdating or corrections).
     * Updates vehicle status to "In Use".
     * 
     * @param rentalID Rental to start
     * @param startDateTime Custom start timestamp
     * @return true if successful, false otherwise
     */
    public boolean startRental(String rentalID, Timestamp startDateTime) {
        ...
        // SET START TIME (use provided timestamp)
     ...
     * Format: PAY-XXXXXX
     * Note: RentalID is now generated by RentalDAO.generateRentalID()
     */
